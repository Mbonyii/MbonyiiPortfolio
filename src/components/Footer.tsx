...
const Footer = () => (
  <footer className="w-full bg-slate-900 py-6 mt-16">
    <div className="container mx-auto text-center flex flex-col items-center gap-2">
      <span className="text-white/80 text-sm">© 2024 Mbonyingabo Naguel. All rights reserved.</span>
      <a
        href="https://github.com/Mbonyii"
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex items-center gap-2 text-white hover:text-blue-400 transition-colors text-base font-medium"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor" className="inline-block">
